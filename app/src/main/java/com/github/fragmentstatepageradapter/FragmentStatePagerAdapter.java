...
/**
 * 此类参考了系统 {@link android.support.v4.app.FragmentStatePagerAdapter}的实现方式
 * 唯一新增的功能是支持对ViewPager中Fragment的增删、排序功能
 * 注意为了使ViewPager中Fragment排序时，原有的Fragment尽可能多地得到复用，子类需要覆盖方法
...
//        }
    ...
    /**
     * 调用改方法之后不能继续使用该FragmentStatePagerAdapter
     */
    public void destroy() {
    ...
    public synchronized void clearCache() {
        if (null != mSavedState && 0 != mSavedState.size()) {
            mSavedState.clear();
        }
